...
export class College_03 extends Container{
    private logo !: Sprite;
    ...
    constructor() {
        super();
        this.y = 50;
        this.building = new Sprite(Game.the.app.loader.resources['college_3_img'].texture);
        this.building.y = 0;
        this.building.scale.set(0.6);
    ...
    private initText() :void{
        ...
        this.gameText = new Text(`Went to\nPunjabi University\nDiploma in Gatka, Patiala Punjab-bhangra cartoon\n2023-24`,style2);
